...
const string strMessageMagic = "shieldcoin Signed Message:\n";
...
{
    int64_t nSubsidy = 222 * COIN;

     if(pindexBest->nHeight < 29)
     {
         nSubsidy = 0 * COIN;
     }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "shieldcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "In NSA-intercepted data, those not targeted far outnumber the foreigners who are";
        CTransaction txNew;
        txNew.nTime = 1404796355;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1404796355;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1991218;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xffc75264161f66a82c97ea8cc261ff038e50e80a9da9e36612e13ffe8703a7f3"));
        block.print();
